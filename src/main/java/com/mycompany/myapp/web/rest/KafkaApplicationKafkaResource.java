...
@RestController
@RequestMapping("/api/kafka-application-kafka")
public class KafkaApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KafkaApplicationKafkaResource.class);
    ...
    public KafkaApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
